 ...
 *
 * Zupt — optional Jasmin-generated crypto declarations
...
/* Branchless MAC comparison (4×u64 XOR accumulation).
...
/* Branchless conditional select (4×u64 masked select).
...
/* Branchless conditional swap (4×u64 masked XOR swap).
...
/* AES-256-CTR 4-block pipeline via AES-NI.
