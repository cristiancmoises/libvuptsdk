 ...
 * optional AES-NI assembly backend is selected by -DZUPT_USE_JASMIN in
 * zupt_aes256_ctr(); this file is the portable fallback for builds without
 * it. The recorded Jasmin verification was not reproduced for this release,
 * and the base archive API does not expose the full ABI's XChaCha20 path.
